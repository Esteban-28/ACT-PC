...
New-ModuleManifest -Path 'C:\Program Files\WindowsPowerShell\Modules\tareas\manifiesto.psd1' -Author "Wi-FiBotz" -RootModule modulo.psm1 -Description "Manifiesto de tarea E2"
